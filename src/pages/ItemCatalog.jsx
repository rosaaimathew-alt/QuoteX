...
export default function ItemCatalog() {
  ...
  const [newForm, setNewForm] = useState({ name: '', category: 'General', unit: 'EA', unitPrice: 0, minPrice: 0, maxPrice: 0, count: 1, confidence: 70 })
  ...
  const saveNew = () => {
    ...
    setAddingNew(false)
    setNewForm({ name: '', category: 'General', unit: 'EA', unitPrice: 0, minPrice: 0, maxPrice: 0, count: 1, confidence: 70 })
  }
