        ...
        <div className="bg-white shadow-lg rounded-sm overflow-hidden" style={docStyle}>
          ...
          <div className="px-6 sm:px-12 py-6 border-t border-gray-200">
            ...
            <ul className="text-[10pt] space-y-1.5 ml-2 mb-4">
              {[
                ...
                'Reconnection of existing cables ,wires, internet, Security systems etc, due construction demolition or new door frame.',
            ...
            <p className="text-[10pt] mb-3">If any unforeseen items are discovered during the course of your work we will immediately bring them to your attention with a recommended course of action. The labor aerials required to correct, adjust, or work around these items will result in additional charges and work will only proceed when authorized by you.</p>
          ...
          <div className="px-6 sm:px-12 py-6 border-t border-gray-200">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-1 text-[10pt] mb-4">
              ...
              <div><strong>HOA:</strong> {hoa==='yes'?'YES':hoa==='no'?'NO':'YES OR NO'}</div>
              <div><strong>Permit :</strong> {permitReq==='yes'?'YES':permitReq==='no'?'NO':'YES OR NO'}</div>
            </div>
